...
تعديل البيانات                </button>
 ...
 يرجي ملىء هذا الحقل بأكثر من 8 حروف وارقام
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            value="{{ $vistore->phone }}" name="phone" required
                                            minlength="10">
                                        <div class="valid-feedback">Valid.</div>
                                        <div class="invalid-feedback">Please fill out this field.</div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"id="exampleFormControlInput1"
                                            value="{{ $vistore->education }}" name="education" required
                                            minlength="4">
                                        <div class="valid-feedback">Valid.</div>
                                        <div class="invalid-feedback">Please fill out this field.</div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            value="{{ $vistore->educational_specialization }}"
                ...
                <table class="table bg-hsl(177, 82%, 27%);">
                    ...
                    <tbody>
                        <tr>
                            ...
                            style="color: hsl(177, 82%, 27%);font-weight:700"
                            >
                                {{ $vistore->educational_specialization }}
