...
@section('container')
    ...
    <body style="overflow-x: hidden">
        <div id="wert" class="border md:mx-5  p-5 mx-2 rounded-xl xl:w-3/6"  dir="rtl" style="width: auto;    background: white;">
...
">
                          ...
                          {{ Auth::user()->name }}
                                ...
                                <td style="display: table-row; justify-content:flex-end"
                ...
                <div class="justify-around margin-center md:flex mt-5" >
                    <div class="text-grey-03  pr-5 " >
                        ...
                        style="color:hsl(177, 82%, 27%);  font-size: x-large;"
                        >  رقم الباحث  </span>
 ...
 {!! QrCode::size(150)->generate(Auth::user()->qr_code ) !!}
                        ...
                        <div class="flex justify-center">
                            ...
                            style="    background: white;font-weight: 700;

color:hsl(177, 82%, 27%);display:none"
                            >
                                طباعة QR كود الباحث
                            </button>
                    ...
                    <div class="text-grey-03 ">
                        <p class="text-start mt-8 sm:mt-0"
                        style="color:hsl(177, 82%, 27%)" id="one" >
                            ملف السيرة الذاتية
                        </p>
                        <br>
                        <div  id="ff" class="bg-grey-04 flex items-center justify-around md:mt-3 p-2 px-4 rounded-xl">
                            <a href="{{ asset('assets/file/' . $user->JopSearch->CV) }}" target="_blank">
                                <svg class="ml-2" width="33" height="33" viewBox="0 0 33 33" fill="none"
                                    ...
                                    <rect x="0.525391" width="32.4746" height="32.3788" rx="10" fill="hsl(177, 82%, 27%);">
                                    </rect>
                                    <path
        ...
        <section class="justify-center xl:flex mx-auto mx-2 " dir="rtl" style="flex-direction: column;" >
            ...
            <div class="  p-5  rounded-xl   " style="justify-content: center;
    display: flex;
    flex-direction: column;">
                    <div class="text-grey font-bold " style="text-align: center;margin-bottom: 2rem;">{{ $SectionPdfs->title }}</div>
                            ...
                            <div class="bg-grey-04 flex p-2 px-4 items-center justify-between rounded-xl ">
                                <a href="{{ asset('assets/file/' . $SectionPdfs->file) }}">
                                    <svg class="margin-start" width="50" height="50" viewBox="0 0 50 50"
                                        ...
                                        <rect width="50" height="50" rx="10" fill="hsl(177, 82%, 27%);"></rect>
                                        <path
        ...
        <section id="three" class=" justify-around mx-2 md:flex mt-12 md:mx-5 p-5 rounded-xl text-center print:hidden ">
            <div class="text-grey-03">
...
">
                ...
                style="color:hsl(177, 82%, 27%);;font-weight: 700;"
                >
                    @php
...
تعديل البيانات                </button>
 ...
 يرجي ملىء هذا الحقل بأكثر من 8 حروف وارقام
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-primary ms-auto" style="width: 150px;color: hsl(177, 82%, 27%);"> ارسال
                                    </button>
                            </form>
                        </div>
                        <div class="modal-footer">
        ...
        <section class="p-5" dir="rtl" id="for">
            ...
            <div class="table-responsive" id="no-more-tables">
                <table class="table bg-hsl(177, 82%, 27%);">
                    ...
                    <tbody>
                        <tr>
                            <td data-title="رقم التليفون"
                            style="color: hsl(177, 82%, 27%);font-weight:700"
                            > {{ $user->JopSearch->phone }}</td>
                            <td data-title="البريد الإلكتروني"
                            style="color: hsl(177, 82%, 27%);font-weight:700"
                            > {{ Auth::user()->email }} </td>
                            <td data-title="المؤهل العلمي"
                            style="color: hsl(177, 82%, 27%);font-weight:700"
                            >
                                {{ $user->JopSearch->education }}
                            </td>
                            <td data-title="رقم الهوية"
                            style="color: hsl(177, 82%, 27%);font-weight:700"
                            >
        ...
        <section id="test" style="margin:0px;padding:0px;width:200px;margin:auto;margin-top:0px" class="text-center bg-hsl(177, 82%, 27%);"   >
